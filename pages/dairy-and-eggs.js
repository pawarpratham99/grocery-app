...
export default function DairyAndEggsPage({ products }) {
  return (
    <>
      <Head>
        <title>Dairy & Eggs - FreshCart</title>
      </Head>
      ...
      <div className={styles.page}>
        ...
        <div className={styles.pageHeader}>
          <h1>🥛 Dairy & Eggs</h1>
          <p>Showing {products.length} fresh dairy products — delivered in 10 mins</p>
        </div>
